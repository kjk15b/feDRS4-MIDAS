...
const char *frontend_name = "feDRS1";  // client name visible to other MIDAS clients
...
DEVICE_DRIVER mcfd_driver[] = {
   {"DRS4", dd_drs4, NUM_CHANNELS, rs232, DF_INPUT},
   {""}
};

EQUIPMENT equipment[] = {

   {"PSI DRS4",                     // equipment name
      ...
      drs4_driver,             // device driver list
      NULL,                       // init string
   },
